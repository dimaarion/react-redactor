...
export default function LiterLineSelectBgColor(props) {
                    ...
                    <tr>
                        <td colSpan="6">
                            <button
                                ...
                                onClick={() => {
                                    selectedStyles(props, "div", false, "background-color:" + rgb + ";");
                                }}
                            >
                                ok
                            </button>
    ...
    return (
        <div className="listItems">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg"  width="2em" fill="currentColor" className="bi bi-paint-bucket" viewBox="0 0 16 16">
