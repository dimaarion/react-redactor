      ...
      <div className="row ">
        ...
        <div className="row  p-2 list">
          ...
          <div className=" col-sm text-left listItems">
            <svg style={(props.gTags.teg === 'A') ? { padding: '2px', backgroundColor: '#cccccc' } : {}} onClick={() => {setstate({"link":true})}} width="2em"  viewBox="0 0 16 16" class="bi bi-link-45deg linkB" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="row p-2">
          ...
          <CloseControl setsizes={props.setsizes} sizes={props.sizes} setpanelStyle={props.setpanelStyle} />
        </div>
      </div>
