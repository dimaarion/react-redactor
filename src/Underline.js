...
function Underline(props) {
    ...
    return (
        <div className={props.class}>
            <svg onClick={() => props.types(props.ititalTegs, props.items, props.selectedtext, 'u')} width="2em"  viewBox="0 0 16 16" className="bi bi-type-underline" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
